    ...
    <div>
      ...
      <div className="container mx-auto max-width-limited mb-20">
        <div className="mx-4">
          ...
          <p className="p">
            Zubora is a JavaScript Unit Test File Generator. It is made for
            zubora (&quot;lazy&quot; in Japanese) developers. It reads your
          ...
          <p className="p">
            ...
            have to maintain those modules with fear. Zubora encourages
            developers to write tests by creating test templates.
          </p>
          <blockquote className="border-l-4 text-3xl my-8 py-3 pl-5 text-gray-700">
            Code as it’s going to be abandoned anytime soon, write test
            otherwise.
          </blockquote>
